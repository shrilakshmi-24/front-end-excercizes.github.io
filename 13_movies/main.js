...
function buildTable(data) {
    ...
    var data1 = pagination(state.querySet, state.page, state.rows)
    var data = data1.querySet
    ...
    for(var i=0; i<data.length;i++) {
        ...
        <td>${data[i].imdb.rating+data[i].tomatoes.viewer.rating}</td>
        <td>${data[i].plot}</td> `
...
// function buildTable(data){
//     tabl=document.getElementById('table-data');
//     for(var i=0;i<data.length;i++){
//        var row=`<tr>
//        <td>${i+1}</td>
//        <td>${data[i].title}</td>
...
function changePage(page){      
    ...
    var page_span = document.getElementById("slno");
var count=1;
    // validate page 
    if (page < 1) page = 1;
